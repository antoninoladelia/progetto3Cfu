...
--
-- Host: 127.0.0.1
-- Creato il: Nov 05, 2017 alle 16:07
...
('root', '[{\"db\":\"prison\",\"table\":\"prisoner\"},{\"db\":\"prison\",\"table\":\"cell\"},{\"db\":\"corso\",\"table\":\"course\"},{\"db\":\"corso\",\"table\":\"student\"}]');
...
('root', 'prison', 'prisoner', '[]', '2017-11-03 14:42:30');
...
('root', '2017-09-26 14:39:23', '{\"lang\":\"it\",\"collation_connection\":\"utf8mb4_unicode_ci\"}');
...
--
-- Struttura della tabella `cell`
--

CREATE TABLE `cell` (
  `Id` int(11) NOT NULL,
  `Block` longtext,
  `Prisoner1` int(11) DEFAULT NULL,
  `Prisoner2` int(11) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dump dei dati per la tabella `cell`
--

INSERT INTO `cell` (`Id`, `Block`, `Prisoner1`, `Prisoner2`) VALUES
(1, 'A', 12, 13),
(2, 'A', 15, 12),
(3, 'A', 11, 1),
(4, 'A', 0, 0),
...
--
-- Struttura della tabella `prisoner`
--
...
CREATE TABLE `prisoner` (
  ...
  `EndPenality` datetime(6) NOT NULL,
  `NamePrisoner` longtext,
  `Residence` longtext,
  `StartPenality` datetime(6) NOT NULL,
  `SurnamePrisoner` longtext
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dump dei dati per la tabella `prisoner`
--

INSERT INTO `prisoner` (`Id`, `BirthPlace`, `Crime`, `DateOfBirth`, `EndPenality`, `NamePrisoner`, `Residence`, `StartPenality`, `SurnamePrisoner`) VALUES
(1, 'Piazza Armerina', 'Furto', '1992-05-19 22:00:00.000000', '2018-11-10 23:00:00.000000', 'Antonino', 'Piazza Armerina', '2012-11-10 23:00:00.000000', 'La Delia'),
(2, 'Enna', 'Furto', '1956-11-10 23:00:00.000000', '2020-11-10 23:00:00.000000', 'Mario', 'Enna', '1980-11-10 23:00:00.000000', 'Rossi'),
(3, 'Roma', 'Stupro', '1988-01-30 00:00:00.000000', '2030-11-11 00:00:00.000000', 'Giovanni', 'Milano', '2017-01-20 00:00:00.000000', 'Batto'),
(4, 'Roma', 'Furto', '1970-10-03 00:00:00.000000', '2019-03-03 00:00:00.000000', 'Giuseppe', 'Napoli', '1999-12-12 00:00:00.000000', 'Verga'),
(5, 'Verona', 'Omicidio', '1975-10-20 00:00:00.000000', '2040-11-11 00:00:00.000000', 'Massimo', 'Vr', '2017-10-11 00:00:00.000000', 'Decimo'),
(10, 'catania', 'Stupro', '2012-12-12 00:00:00.000000', '2222-11-11 00:00:00.000000', 'Antonino', 'catania', '2121-02-21 00:00:00.000000', 'La Delia'),
(12, 'Agrigento', 'Omicidio', '1980-11-11 00:00:00.000000', '2018-01-01 00:00:00.000000', 'Giacomo', 'Mazzara del Vallo', '1992-12-05 00:00:00.000000', 'Ventimiglia'),
(13, 'Alcamo', 'Stupro', '1978-12-11 22:00:00.000000', '2020-06-21 20:00:00.000000', 'Daniele', 'Palermo', '2012-11-10 22:00:00.000000', 'Bologna');
...
--
-- Indici per le tabelle `cell`
--
ALTER TABLE `cell`
  ADD PRIMARY KEY (`Id`);

--
-- Indici per le tabelle `prisoner`
--
...
--
-- AUTO_INCREMENT per la tabella `cell`
--
ALTER TABLE `cell`
  MODIFY `Id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT per la tabella `prisoner`
--
ALTER TABLE `prisoner`
